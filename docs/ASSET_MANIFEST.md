...
Inventory completed on 2026-08-17 and updated after Milestone 7. All supplied files are PNG images in RGB mode and therefore contain no alpha channel in their original form. The `assets-original/` directory is protected; no source file was modified, renamed, resized, overwritten, cropped, converted, or deleted.
...
- No external asset service, paid tool, generated replacement, downloaded character art, or downloaded audio was used for Milestones 1–7.
...
|---|---|---|---|---|---|---|---|
| `Angel Character Sheet.png` | PNG, 1536×1024 | Angel reference sheet: front, side, back, 3/4, happy, thinking, surprised, and excited views. The character has multiple arms. | Angel character sprites and expression portraits. | Yes, for isolated character sprites. | Yes; each labelled pose would need a separate derivative. | Solid white background, labels, and several poses in one image. Extraction must preserve the multiple-arm design and fine outlines. | Milestone 2: front, happy, thinking, and excited derivatives created. Milestones 4–7: prepared derivatives reused for Story Time, Carnival arrival, Pan Jam, the Moko Jumbie sequence, and Angel’s trust-dependent Carnival Crisis reactions. |
...
| `Jungle background.png` | PNG, 1536×1024 | Bright tropical jungle path with stream, waterfall, flowers, butterflies, mushrooms, and trees. | Possible future story environment. | No; intended as a full-frame background. | No for background use. | 3:2 aspect ratio, so a future 16:9 presentation will require contain/cover decisions without stretching. | Not used through Milestone 5. |
| `Junior Character Sheet.png` | PNG, 1369×1149 | Junior reference sheet: front, side, back, 3/4, happy, thinking, surprised, and excited views. | Junior character sprites and expression portraits. | Yes, for isolated character sprites. | Yes; each labelled pose would need a separate derivative. | Solid white background, labels, and several poses in one image; narrow features and outlines need careful masking. | Milestone 2: front, happy, thinking, and surprised derivatives created. Milestones 4–7: prepared derivatives reused for Story Time, Carnival arrival, Pan Jam, the Moko Jumbie explanation, and Junior’s observant Carnival Crisis contribution. |
| `Kiddies Carnival Background.png` | PNG, 1536×1024 | Empty Carnival street/plaza with steelpan stage, banners, balloons, houses, and two distant Moko Jumbies. | Carnival arrival, lightweight exploration, and future mini-game environment. | No; intended as a full-frame background. | No source crop or derivative extraction. | 3:2 aspect ratio; proportional cover scaling creates only a reversible top/bottom presentation crop and never stretches the image. Source SHA-256: `34CE7DB71294697ED07D9FE32F751B51B6A0CB47A8D5EB7010270F435543917E`. | Milestones 4–5: unchanged runtime copy used by `CarnivalScene`, including the narrative handoff into Pan Jam. Milestone 7: the same runtime copy is reused as the Carnival Crisis backdrop. |
| `Kiddies Carnival scene.png` | PNG, 1672×941, RGB | Busy Carnival parade with children playing pans, dancers, crowd, confetti, flags, and three prominent Moko Jumbies. | Full-frame Moko Jumbie reveal and Carnival story scene. | No; intended as a full-frame illustration. | No source crop or sprite extraction. The figures remain embedded in the complete composition. | Near-16:9; dense embedded characters require foreground UI to avoid covering the central Moko Jumbies. Source SHA-256: `DB6D77E8E00821E917D1380564841A965FE5E779FB46F11882394D60F9911BB5`. | Milestone 6: used prominently as the unchanged Moko Jumbie parade reveal. |
| `kiddies carnival.png` | PNG, 1672×941 | Carnival street scene with pan players, dancers, crowd, banner, and Lexi centered in the foreground. | Future Carnival story/cinematic scene featuring Lexi. | No for full-frame use. | Cropping would be required only if attempting to isolate embedded characters, which is not recommended without manual preparation. | Near-16:9; Lexi and other figures are baked into the scene, limiting independent animation. | Not used through Milestone 5. |
| `Lexi Character Sheet.png` | PNG, 1369×1149 | Lexi reference sheet: front, side, back, 3/4, happy, thinking, surprised, and excited views. | Canonical Lexi sprites and expression portraits. | Yes, for isolated character sprites. | Yes; individual poses need reversible derivative extraction. | Solid white background, labels, and several poses in one image. White areas enclosed by outlines must not be removed during background extraction. | Milestone 1: front derivative. Milestone 2: happy and excited derivatives added. Milestones 4–7: prepared derivatives reused for Story Time, Carnival arrival, Pan Jam, Moko Jumbie support, and player-directed Carnival Crisis reactions. |
| `lexi making wings.png` | PNG, 1672×941, RGB | Original Young Folk illustration of Lexi making decorated butterfly Carnival wings at the CC Club craft table. | Primary visual backdrop for the Carnival Costume Challenge and a reference for the four illustrated sequencing steps. | No; intended as a full-frame scene. | No cropping or sprite extraction is required for Milestone 3. | Near-16:9 with Lexi, wings, craft materials, signage, and room details embedded in one illustration. Source SHA-256 recorded at integration: `2BF95F6438340AF77CF77BCCF33BF532E50FC3F22F3CC8FD8609660FAF48198B`. | Milestone 3: used prominently as the full-scene costume-making backdrop via an unchanged runtime copy. Milestone 7: the same runtime copy appears as a small visual reminder of the earlier wing-making choice. |
| `Outside the CC Club.png` | PNG, 1672×941 | Exterior of the Community and Cultural Club with tropical plants, parrots, butterflies, and an open door. | Future episode opening, exterior transition, or title material. | No; intended as a full-frame background. | No for background use. | Near-16:9; signs and wildlife are embedded in the illustration. | Not used through Milestone 5. |
| `pan kids.png` | PNG, 1672×941, RGB | Four children playing steelpans beneath a Kiddies Carnival banner. | Pan Jam visual backdrop and future Carnival story material. | No; used as a full-frame illustration. | No crop or sprite extraction. The playable pan zones are separate code-drawn interface objects and do not alter the artwork. | Near-16:9; children and instruments are baked into the scene. Source SHA-256: `F7D93360CFA3091F956729D1C5944740922DE8EAF3E506013262E301D34D9DDD`. | Milestone 5: unchanged runtime copy used prominently behind the playable Pan Jam steelpan. |
| `Story pot.png` | PNG, 1672×941 | Close view of the glowing story pot in the CC Club with floating cultural symbols. | Story Time transition and magical travel cinematic. | No; intended as a full-frame illustration. | No for full-frame use; the pot and effects are embedded. | Near-16:9; background blur and glow are baked in, so it is not an isolated pot sprite. Source SHA-256: `7CDAC762CF66827CFABE99BAF7438D0C42DD8767CFDFC67D8799B7EBCECE47F0`. | Milestones 4–5: unchanged runtime copy used by the retained Story Time transition. |

## Runtime assets created for Milestone 1

| Runtime file | Source | Preparation | Result and use |
|---|---|---|---|
| `public/assets/backgrounds/cc-club/cc-club-interior.png` | `Community Cultural Club Background.png` | Byte-for-byte file copy; no transformation. | 1672×940 RGB PNG used by the title, club, completion, and Story Time scenes through Milestone 5. |
...
|---|---|---:|---|
| `assets-original/lexi making wings.png` | `public/assets/backgrounds/cc-club/lexi-making-wings.png` | RGB PNG, 1672×941 | Byte-for-byte runtime copy made by `scripts/prepare-assets.py`; only the destination filename is normalized for the runtime asset tree. No crop, resize, resampling, recolouring, masking, compression change, generative processing, or artwork alteration was performed. Used as the full-frame Milestone 3 costume challenge backdrop and reused unchanged as a small Milestone 7 memory vignette. The source and runtime SHA-256 values both equal `2BF95F6438340AF77CF77BCCF33BF532E50FC3F22F3CC8FD8609660FAF48198B`. |
...
| `assets-original/Kiddies Carnival Background.png` | `public/assets/backgrounds/carnival/kiddies-carnival-background.png` | RGB PNG, 1536×1024 | Byte-for-byte runtime copy made by `scripts/prepare-assets.py`. No image transformation was performed. `CarnivalScene` and `CarnivalCrisisScene` use proportional cover scaling at runtime, producing a reversible presentation crop without changing or stretching the file. Source and runtime SHA-256 values both equal `34CE7DB71294697ED07D9FE32F751B51B6A0CB47A8D5EB7010270F435543917E`. |

## Runtime scene asset created for Milestone 5

| Original source | Runtime file | Type and dimensions | Preparation and use |
|---|---|---:|---|
| `assets-original/pan kids.png` | `public/assets/backgrounds/carnival/pan-kids.png` | RGB PNG, 1672×941 | Byte-for-byte runtime copy made by `scripts/prepare-assets.py`; only the destination name is normalized. No crop, resize, resampling, recolouring, masking, compression change, generative processing, or external service was used. It fills the Pan Jam scene behind a translucent overlay and separate code-drawn controls. Source and runtime SHA-256 values both equal `F7D93360CFA3091F956729D1C5944740922DE8EAF3E506013262E301D34D9DDD`. |

## Runtime scene asset created for Milestone 6

| Original source | Runtime file | Type and dimensions | Preparation and use |
|---|---|---:|---|
| `assets-original/Kiddies Carnival scene.png` | `public/assets/backgrounds/carnival/kiddies-carnival-scene.png` | RGB PNG, 1672×941 | Byte-for-byte runtime copy made by `scripts/prepare-assets.py`; only the destination name is normalized. No crop, resize, resampling, recolouring, masking, compression change, generative processing, or external service was used. `MokoJumbieScene` presents the complete artwork behind code-drawn reveal lighting, dialogue, characters, and controls. Source and runtime SHA-256 values both equal `DB6D77E8E00821E917D1380564841A965FE5E779FB46F11882394D60F9911BB5`. |

## Milestone 7 asset reuse (no new runtime files)

- `CarnivalCrisisScene` reuses the unchanged Milestone 4 Carnival background, the unchanged Milestone 3 `lexi-making-wings.png` runtime copy, and the existing Milestone 2 Lexi, Angel, and Junior expression derivatives.
- The loose butterfly-wing fastening, intact-wing/nearby-costume branch indicators, three repair-material controls, safety clip, fastening progress, and completion sparkles are code-drawn Phaser presentation. They are not saved image derivatives and do not alter the supplied artwork.
- No original asset, runtime asset, derivative, audio file, external asset, commercial asset pack, image-generation service, or paid tool was added or changed for Milestone 7.
