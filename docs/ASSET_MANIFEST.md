...
Inventory completed on 2026-08-17 and updated after Milestone 2. All supplied files are PNG images in RGB mode and therefore contain no alpha channel in their original form. The `assets-original/` directory is protected; no source file was modified, renamed, resized, overwritten, cropped, converted, or deleted.
...
- No external asset service, paid tool, generated replacement, or downloaded character art was used for Milestones 1 or 2.
...
|---|---|---:|---|
| `Lexi Character Sheet.png` | `public/assets/characters/lexi/lexi-front.png` | RGBA PNG, 344×458 | Milestones 1–2: neutral Lexi presentation. |
...
| `Angel Character Sheet.png` | `public/assets/characters/angel/angel-front.png` | RGBA PNG, 361×412 | Milestone 2: neutral Angel presentation. |
...
| `Junior Character Sheet.png` | `public/assets/characters/junior/junior-front.png` | RGBA PNG, 270×440 | Milestone 2: neutral Junior presentation. |
...
The extraction procedure is reproducible in `scripts/prepare-assets.py` and writes only to `public/assets/`. It:
